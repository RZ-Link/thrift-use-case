...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.22.0)", date = "2025-09-28")
...
public class Calculator {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends shared.SharedService.AsyncProcessor<I> {
    ...
    public static class add<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, add_args, Integer, add_result> {
      public add() {
        super("add");
      }
    ...
    public static class calculate<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, calculate_args, Integer, calculate_result> {
      public calculate() {
        super("calculate");
      }
